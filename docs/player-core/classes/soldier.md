...
A Soldier with a high Constitution hits harder with their signature gear, soaks more punishment, and posts a wider, deadlier kill-zone. Constitution is your attack key for Suppression, the basis of your **Soldier class DC**, and the engine of your durability — so you rarely need a second attribute.
...
**Success** The creature takes half the weapon's damage and becomes **suppressed**.
**Failure** The creature takes the weapon's full damage and becomes **suppressed**.
**Critical Failure** The creature takes double the weapon's damage and becomes **suppressed**.
...
> *Sergeant Vossk spends two actions on Suppressing Fire, painting a 15-foot cone across the corridor mouth (class DC 21). A battle droid rolls a 14 to save — a failure: it takes full damage and is suppressed (–1 to hit, –10 feet Speed). On the droid's turn it tries to push through the cone toward the party's medic. Moving inside the zone triggers Vossk's Suppressing Reaction; he fires a covering shot at full accuracy, no MAP. With his third action that turn he'd already shot the suppressed droid using **Overwhelming Assault**, so even his follow-up came in sharp.*
