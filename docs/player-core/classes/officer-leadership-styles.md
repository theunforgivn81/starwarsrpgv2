...
**(7th level)** **Effect** Attempt a Deception check to Feint a foe against its Perception DC. On a success, it's **off-guard to your whole squad** (not just you) until the start of your next turn.
...
**(7th level)** **Effect** You make a dazzling display. Each enemy that can see you is **off-guard** until the start of your next turn, and each ally who can sense you gains temporary Hit Points equal to your Charisma modifier.
