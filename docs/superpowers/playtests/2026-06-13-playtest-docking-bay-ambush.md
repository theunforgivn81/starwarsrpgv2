...
| **F2** | **Major** | R1 Troopers | [Phase 1 §11](../specs/2026-06-13-phase1-core-mechanic-and-traits.md), [remediation S5](../specs/2026-06-13-connective-tissue-and-review-remediation.md) | cross-subsystem hole | **Reactive Shot is target-only, but "don't charge a firing line" implies many shooters.** Trigger = "a melee Strike against **you**," so meleeing one gunner among several draws **one** shot; §11's counter-flavor ("a foe that already spent its reaction") implies multiple. Intent vs RAW mismatch. Fix: add a "Covering Fire" reaction for nearby gunners, *or* accept target-only and correct the flavor. | ttrpg-system-review |
| **F3** | **Major** | R1–R2 Kira | [Phase 5 §4.1](../specs/2026-06-13-phase5-class-design-and-force.md) | exploit / hole | **At-will (0-Attunement) forced movement × undefined hazard/fall rules.** Telekinetic Nudge can shove enemies toward a pit/hazard **every turn for free**; no rules for forced movement into edges/hazards or falling. Cheap repeatable save-or-die vs any ledge encounter. Fix: define forced-movement-into-hazard (save/stop at edge), and/or gate displacement on Attunement. | ttrpg-system-review + ttrpg-ability-design |
| **F6** | **Major** | R2 Kira | [Phase 5 §2.2](../specs/2026-06-13-phase5-class-design-and-force.md), [Gate A §5](../specs/2026-06-13-gateA-balance-validation.md) | number (blocks play) | **Attunement loop is unrunnable as written.** Pool size, Center regain, per-power costs, and Push costs are all soft — the GM cannot adjudicate how many powers the Guardian gets in a fight. The class's signature resource is undefined at the table. Fix: lock provisional Attunement/Center/Push/power costs (the §5 soft numbers) *before* any playtest. | ttrpg-balance-analysis + ttrpg-ability-design |
| **F7** | **Major** | R2 Bex | [Phase 6 §3](../specs/2026-06-13-phase6-equipment-and-economy.md), [Gate A §1](../specs/2026-06-13-gateA-balance-validation.md) | number | **Stim heal + tolerance curve unstated.** "First use ~25–30%, tolerance halves" isn't in usable rules text; the GM/player can't compute a heal or plan around tolerance. Fix: print exact stim values + the tolerance rule. | ttrpg-balance-analysis + ttrpg-rules-writing |
