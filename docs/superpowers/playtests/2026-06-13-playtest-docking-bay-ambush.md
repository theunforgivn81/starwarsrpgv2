...
|---|---|---|---|---|---|---|
| **F1** | **Major** ✅ **RESOLVED** | R1 Inquisitor | [Phase 7 §9](../specs/2026-06-13-phase7-creatures-and-challenge.md) | creature behaviour | **Boss anti-ranged signature backfired** (deflection funneled PCs into safe, deadlier melee vs a saber boss). **Resolution (2026-06-13):** (a) **guideline** added to Phase 7 §5 — "close the engagement loop: whatever an enemy denies, it must threaten the alternative"; (b) **Inquisitor redesigned** — paired the deflection with a telegraphed AoE **Force Repulse** (punishes the melee cluster the deflection creates) and a **Phase-2 mode flip** (goes ranged → now Reactive-Shots meleers), plus ranged adds. The signature is now a feature, not an own-goal. | ttrpg-creature-design (done) |
...
| **F4** | **Minor** ✅ **RESOLVED** | R1 Bex | [connective-tissue §F](../specs/2026-06-13-connective-tissue-and-review-remediation.md) | action economy | **Drone was a persistent action-positive engine** (free uncommanded action each round). **Resolution (2026-06-13):** general **Commanded Actor** framework — companions take **no** actions unless **Command**ed (1 action → 2 weaker actions), so no net free actions. Drone conforms. | ttrpg-balance-analysis (done) |
| **F5** | **Minor** ✅ **RESOLVED** | R1 Bex | [connective-tissue §F](../specs/2026-06-13-connective-tissue-and-review-remediation.md) | ambiguous text | **Drone turn/initiative/reaction undefined.** **Resolution:** Commanded Actors act **on the commander's turn**, **no separate initiative**, **no reaction by default**. Applies system-wide (drones, pets, summons, enemy adds). | ttrpg-rules-writing + ttrpg-ability-design (done) |
