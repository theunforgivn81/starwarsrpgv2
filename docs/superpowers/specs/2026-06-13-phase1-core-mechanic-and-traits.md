...
> **Reactive Shot** `[reaction]` — **Trigger:** a creature you can perceive makes a melee Strike while **within 10 feet of you**, you have a ranged weapon ready, and your reaction is available. **Effect:** make a ranged Strike against the triggering creature; it resolves *before* the triggering melee Strike (so it can disrupt it).
